...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.type_category'
        db.add_column(u'app_category', 'type_category',
                      self.gf('django.db.models.fields.CharField')(default='u', max_length=1),
                      keep_default=False)


        # Changing field 'Category.update_category'
        db.alter_column(u'app_category', 'update_category', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting field 'Category.type_category'
        db.delete_column(u'app_category', 'type_category')


        # Changing field 'Category.update_category'
        db.alter_column(u'app_category', 'update_category', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        u'app.category': {
            ...
            'update_category': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'app.item': {
